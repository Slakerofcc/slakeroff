...
<div class="text-center">
        <h2 class="text-light"><b>BB V4<br>VBV/MSC 1 CURL</b></h2><br>
        <div class="text-center ">
        <center><h class="text-light"><b><p>ᴄᴏᴅᴀᴅᴏ ᴘᴏʀ @SLAKER7</p></b></h></center>
		<center><h class="text-light"><b><span class='badge badge-warning'>Use E Abuse !</span></b></h></center>
		<center><h class="text-light"><b><span class='badge badge-dark'>FORMATO : CC|MÊS|ANO|CVV</span></b></h></center>
...
var audioLive = new Audio('live.mp3');
	...
	<center><h class="text-light"><b>OBS : TODO CHK VBV/MSC<br>VERIFICANDO SE TEM<br>REDIRECIONAMENTO<br>DO SITE DA BB<br>TEM RISCO DE<br>FALSE LIVE EM 50%<br>NÃO CULPE A GATE<br>OU O CODER</b></h></center><br><br>
